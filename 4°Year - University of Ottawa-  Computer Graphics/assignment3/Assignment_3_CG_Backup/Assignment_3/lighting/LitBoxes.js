// ==========================================================================
// $Id: LitBoxes.js,v 1.5 2019/03/07 06:16:01 jlang Exp $
...
//
// Revision 1.4  2019/03/07 05:59:04  jlang
// solution
//
// Revision 1.3  2019/03/07 02:50:02  jlang
...
function main() {
 ...
 setDefault(); // set global variables to default
  ...
  readShaderFile(gl, 'shader/lit_boxes.vs', 'v');
  readShaderFile(gl, 'shader/lit_boxes.fs', 'f');
}
...
function start(gl) {
  ...
  for ( let index=0; index < lights.length; index++ ) {
	...
	this.directional = (lights[index].position[3] < 1e-6);
