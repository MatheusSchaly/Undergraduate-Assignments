...
function main() {
	...
	mtlLoader.load('dino50K.mtl', function (materials) {
		materials.preload();
		var objLoader = new THREE.OBJLoader();
		objLoader.setMaterials(materials);
		objLoader.setPath('./models/');
		objLoader.load('dino50K.obj', function (object) {
			scene.add(object);
...
function init() {
	...
	// OrbitControls, uncomment to activate. 
	// If orbit controls are allowed, simply uncomment the 
    // two lines below and the line inside the render function
