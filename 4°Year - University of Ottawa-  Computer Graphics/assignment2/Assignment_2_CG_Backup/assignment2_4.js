...
function main() {
	...
	var cameraOrthoHelper;
		...
		camera = new THREE.OrthographicCamera( 10 * aspect / - 2, 10 * aspect / 2, 5 / 2, 5 / - 2, 0, 1000 );
		camera.position.y = -100;
		camera.position.x = -50;
		camera.position.z = 50;
		camera.lookAt(at);
		
		cameraOrtho = new THREE.OrthographicCamera( 10 * aspect / - 2, 10 * aspect / 2, 5 / 2, 5 / - 2, 0, 1000 );
