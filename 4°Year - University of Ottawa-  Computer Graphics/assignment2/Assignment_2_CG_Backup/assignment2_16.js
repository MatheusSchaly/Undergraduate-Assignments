...
function init() {
	...
	var gui = new dat.GUI();
	gui.add(controls, 'left_line', -5.0, 5.0).onChange(controls.frustum);
	gui.add(controls, 'right_line', -5.0, 5.0).onChange(controls.frustum);
	gui.add(controls, 'top_line', -5.0, 5.0).onChange(controls.frustum);
	gui.add(controls, 'bottom_line', -5.0, 5.0).onChange(controls.frustum);
	gui.add(controls, 'near_line', -3.0, 8.0).onChange(controls.frustum);	
	gui.add(controls, 'far_line', -5.0, 5.0).onChange(controls.frustum);	
