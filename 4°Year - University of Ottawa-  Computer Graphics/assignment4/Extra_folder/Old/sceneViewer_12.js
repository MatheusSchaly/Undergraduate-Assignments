...
var original_eye = new THREE.Vector3( -60, 40, -100);
var object;
...
function main() {
	...
	// Right front light
	var rightFrontGeometry = new THREE.CircleGeometry(2, 10);
    var rightFront = new THREE.Mesh(rightFrontGeometry, windowMaterial);
    rightFront.position.set(7.5, 4.5, 30.5);
    pickupTruck.add(rightFront);


	// Left front light
	var leftFrontGeometry = new THREE.CircleGeometry(2, 10);
    var leftFront = new THREE.Mesh(leftFrontGeometry, windowMaterial);
    leftFront.position.set(-7.5, 4.5, 30.5);
    pickupTruck.add(leftFront);
	...
	rightHeadlight.target = rightFront;
	rightHeadlight.decay = 2;
	rightHeadlight.distance = 450;
	...
	leftHeadlight.target = leftFront;
	...
	pointCameraLight.intensity = 0.15;
