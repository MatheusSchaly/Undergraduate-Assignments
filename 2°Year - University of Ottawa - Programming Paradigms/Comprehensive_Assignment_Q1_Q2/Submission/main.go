	...
	for {
		...
		for i := 0; i < len(line); i++ {
			if i == 0 {
				...
				// if you are having incorrect answers, uncomment the lines from 191 to 196 and from 199 to
				// 203 and comment the lines 197 and 204. Also change the "Thales" at line 199 to the first element
