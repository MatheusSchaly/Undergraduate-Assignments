...
public class StaticIDTest {
    ...
    private void showPersonListTest() {
        ...
        PERSON_LIST.add(new Employee("Orin Curry", "15/01/1976", "@email.com", "01/03/2000", 40, "22.80"));
        PERSON_LIST.add(new Student("Bruce Wayne", "02/05/1996", "@email.com", "01/03/2017"));
        PERSON_LIST.add(new Professor("Stephen Vincent Strange", "@email.com", "23/06/1971", "05/08/1996", 40, "22.80", AcademicDegree.DOCTORATE));
        PERSON_LIST.add(new Student("Emma Grace Frost", "23/09/1994", "@email.com", "31/07/2016"));
        PERSON_LIST.add(new Employee("Susan Kent-Barr", "06/10/1969", "@email.com", "09/08/1995", 40, "25.23"));
