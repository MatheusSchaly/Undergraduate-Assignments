...
//        CONTACTS.sort(oderBy == OrderBy.NAME ? NAME_ORDER : EMAIL_ORDER);
    }
...
class ContactBookLocalTest {
    ...
    public static void addContacts() {
        ...
        contactBook.add(new Employee("Orin Curry", "15/01/1976", "orin@com", "01/03/2000", 40, "22.80", a1));
        contactBook.add(new Student("Bruce Wayne", "02/05/1996", "wayne@com", "01/03/2017", a1));
        contactBook.add(new Professor("Stephen Vincent Strange", "23/06/1971", "strange@com", "05/08/1996", 40, "22.80", AcademicDegree.DOCTORATE, a1));
        contactBook.add(new Student("Emma Grace Frost", "23/09/1994", "frost@com", "31/07/2016", a1));
        contactBook.add(new Employee("Susan Kent-Barr", "06/10/1969", "susan@com", "09/08/1995", 40, "25.23", a1));
