...
function init() {
	...
	var mesh
	var cameraRig, activeCamera, activerHelper;
	var cameraPerspective, cameraOrtho;
	var cameraPerspectiveHelper, cameraOrthoHelper;
	var frustum = 60.0

	cameraPerspective = new THREE.PerspectiveCamera( 50, 0.5 * aspectRatio, 1.50, 10.00 );
	cameraPerspectiveHelper = new THREE.CameraHelper( cameraPerspective );
	scene.add( cameraPerspectiveHelper );

	//
	cameraOrtho = new THREE.OrthographicCamera( 0.5 * frustumSize * aspectRatio / - 2, 0.5 * frustumSize * aspectRatio / 2, frustumSize / 2, frustumSize / - 2, 15.0, 10.00 );
