...
function main() {
	...
	var controls = new function () {
		...
		// this.change_driver_view = function () {
			// if (front_driver_view) {
				// console.log('here');
				// cameraPerspe.position.z = 16;
				// front_driver_view = false;
			// } else {
				// cameraPerspe.position.z = -160;
				// front_driver_view = true;
			// }
		// };
	...
	function render() {
		...
		// if (front_driver_view) {
			// console.log('oieee')
			// back_human_eye.x = pickupTruck.position.x;
			// back_human_eye.y = pickupTruck.position.y + 16;
			// back_human_eye.z = pickupTruck.position.z + 40;
		// } else {
			// console.log('eqowke')
			// back_human_eye.x = pickupTruck.position.x;
			// back_human_eye.y = pickupTruck.position.y + 15;
			// back_human_eye.z = pickupTruck.position.z - 40;
		// }
