...
function main() {
	...
	cameraPerspe = new THREE.PerspectiveCamera(50, aspect, 1, 100000);
	cameraPerspeHelper = new THREE.cameraPerspeHelper(cameraPerspe);
	cameraPerspe.position.x = original_eye.x;
	cameraPerspe.position.y = original_eye.y;
	cameraPerspe.position.z = original_eye.z - 60;
