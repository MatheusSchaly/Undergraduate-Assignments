...
function main() {
	...
	var mainMaterial = new THREE.MeshBasicMaterial({ color: 'lightblue' });
    var bodyMaterial = new THREE.MeshBasicMaterial({ color: 'blue' });
	var openMaterial = new THREE.MeshBasicMaterial({ color: 'green' });
	var windowMaterial = new THREE.MeshBasicMaterial({ color: 'lightgrey' });
	var axisMaterial = new THREE.MeshBasicMaterial({ color: 'red'  });
	var wheelMaterial = new THREE.MeshBasicMaterial({ color: 'brown'  });
	...
	var controls = new function () {
		...
		this.updateCamera = function() {
			...
			console.log('cameraOrtho.left' + cameraOrtho.left);
			console.log('cameraOrtho.right' + cameraOrtho.right);
			console.log('cameraOrtho.bottom' + cameraOrtho.bottom);
			console.log('cameraOrtho.top' + cameraOrtho.top);
			console.log('cameraOrtho.near' + cameraOrtho.near);
			console.log('cameraOrtho.far' + cameraOrtho.far);
			
			console.log('camera.position.x' + camera.position.x)
			console.log('camera.position.y' + camera.position.y)
			console.log('camera.position.z' + camera.position.z)
			
			console.log('left_line:' + this.left_line)
			console.log('right_line:' + this.right_line)
			console.log('top_line:' + this.top_line)
			console.log('bottom_line:' + this.bottom_line)
			console.log('near_line:' + this.near_line)
			console.log('far_line:' + this.far_line)
			console.log('eye_x:' + this.eye_x)
			console.log('eye_y:' + this.eye_y)
			console.log('eye_z:' + this.eye_z)
	...
	gui.add(controls, 'far_line', -200.0, 100.0).onChange(controls.frustum);
	gui.add(controls, 'eye_x', -10.0, 10.0).onChange(controls.frustum);
	gui.add(controls, 'eye_y', -10.0, 10.0).onChange(controls.frustum);
	gui.add(controls, 'eye_z', -10.0, 10.0).onChange(controls.frustum);
